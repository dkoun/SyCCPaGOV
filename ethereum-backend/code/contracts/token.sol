...
contract MyToken is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    uint256 public tokenPrice = 0.0001 ether; // This value denotes 1 ETH = 10000 Tokens
    ...
    function approveAll() public returns (bool) { //give the right to the contract to spend all the tokens of the user
    ...
    function mint(address to) public payable {
        require(msg.value >= 0.0001 ether,"Invalid amount sent");
